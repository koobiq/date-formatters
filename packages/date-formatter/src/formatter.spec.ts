...
describe('DateFormatter', () => {
    ...
    describe('core', () => {
        ...
        it('should pass time options to opened long datetime ranges', () => {
            const start = DateTime.local(2026, 3, 16, 11, 48, 15, 547);
            const end = DateTime.local(2026, 3, 16, 11, 48, 15, 547);

            expect(formatter.rangeLongDateTime(start, undefined, { seconds: true })).toBe('From March 16, 11:48:15');
