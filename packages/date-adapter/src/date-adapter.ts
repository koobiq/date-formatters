...
export abstract class DateAdapter<D> {
    public config!: DateAdapterConfig;
     ...
     * @param date - The date to add units to
     * @param amount - The amount to add (number with unit param) or duration object with multiple units
     * @param unit - The unit type (e.g., 'days', 'months', 'years') when amount is a number
     * @returns A new date with the specified units added
     */
    abstract addCalendarUnits(date: D, amount: number | DurationObjectUnits, unit?: DurationUnit): D;
    ...
    abstract durationObjectFromDates(
        start: D,
        end: D,
        units: DurationUnit[],
    ...
    abstract durationAs(durationObject: DurationObjectUnits, unit: DurationUnit): number;

    abstract durationFormat(durationObject: DurationObjectUnits, displayFormat: any): string;

    /** "Set" given date to the beginning of the given unit. */
    abstract startOf(date: D, unit: DateUnit): D;
